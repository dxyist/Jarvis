...
public class MyRoutineTaskRecyclerViewAdapter extends RecyclerView.Adapter<MyRoutineTaskRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRoutineTaskRecyclerViewAdapter(ArrayList<RoutineTask> items, OnListFragmentInteractionListener listener) {
        routineTasks = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_routinetask, parent, false);
